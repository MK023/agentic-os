...
python3 scripts/prova-prezzario-allineato.py [--prova]         # gate: model names identical in main.py, both Grafana panels and the promtool test; `--prova` asserts the gate goes red on 6 mutants. Both, ~0.45s (measured)
