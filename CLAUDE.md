...
python3 scripts/prova-prezzario-allineato.py                   # gate: model names identical in main.py, the Grafana panels and the promtool test — run before opening a PR that adds a model
